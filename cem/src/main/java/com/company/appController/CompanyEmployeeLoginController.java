...
public class CompanyEmployeeLoginController {
	//private static final Log log = LogFactory.getLog(CompanyEmployeeLoginController.class);
		...
		try {
            ...
            if (isbankUser) {//going to log as bank user
                ...
                while ((responseFromBR = br.readLine()) != null) {
                    ...
                    userData.setUSER_ROLE(jSONObject.get("userRole") != null ? jSONObject.get("userRole").toString() : "");
                ...
                if (dfum == null) {
                    ...
                    userData.setUSER_ROLE(ApplicationConstants.USER_ROLE_FD_USER);
