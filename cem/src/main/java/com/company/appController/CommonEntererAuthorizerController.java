...
public class CommonEntererAuthorizerController {
	...
	public ModelAndView existingCommonEntererAuths(HttpServletRequest req, HttpServletResponse resp,HttpSession session) {
		...
		Map<String, DivInfo> divInfoMap = new HashMap();//to store Dep infomation
	...
	public ModelAndView searchCommonEntererAuths(HttpServletRequest req, HttpServletResponse resp,HttpSession session) {
		System.out.println("ENTERED | CommonEntererAuthorizerController.existingCommonEntererAuths()");
		ModelAndView mv = new ModelAndView("CommonEntererAuth/existingCommonEntererAuth");
		ObjectManager objManager = null;
		UserData userData = null;
	...
	public ModelAndView createCommonEneterAuth(HttpServletRequest req, HttpServletResponse resp,HttpSession session) {
		...
		try {
        	...
        	companyUserModel = objManager.get("companyUserModel")!=null?(CompanyUserModel)objManager.get("companyUserModel"):null;
        	...
        	//String cmnUserId, String cmnUserRole, String userStatus,String actionType
        	cmnModel = new CommonUserModel(companyUserModel.getCompanyUserEmpId(),role,ApplicationConstants.STATUS_ACTIVE,ApplicationConstants.ACTION_TYPE_NEW);
	...
	public ModelAndView modifyCommonEneterAuth(HttpServletRequest req, HttpServletResponse resp,HttpSession session) {
		...
		try {
        	...
        	String status = "A";
        	System.out.println("ENTERED | id : "+id+" , status : "+status);  
        	int masterId = 0;
