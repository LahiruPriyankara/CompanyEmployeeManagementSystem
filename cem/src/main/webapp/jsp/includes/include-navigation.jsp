...
<nav class="navbar navbar-default" style="background-color: #3399ff">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a class="titleLink" href="#" id="allEmployee" onclick="clickOnTab('<%=sURLPrefixx%>/CompanyEmployee/ExistingEmp')" style="background-color: #1a8cff;margin-right: 1px;color: #ffffff;width: 150px;text-align: center"><b>Bank Employee</b></a></li>
